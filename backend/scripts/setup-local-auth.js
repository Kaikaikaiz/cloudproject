...
try {
  ...
  source = await readFile(new URL('../.env.example', import.meta.url), 'utf8');
}
...
if (
  ...
  set('JWT_SECRET', randomBytes(48).toString('hex'));
...
try {
  ...
  if (generatedPassword)
    console.log('Generated admin password (save it now): ' + generatedPassword);
