    ...
    <section className="auth-page">
      <div className="auth-card">
        <StatusBadge tone="lavender">
          {register ? 'Join the community' : 'Your little corner'}
        </StatusBadge>
        <h1>{register ? 'Your next chapter.' : 'Welcome back.'}</h1>
        <p>
          {register
            ? 'Good finds and fresh beginnings await.'
            : 'Your favourite finds missed you.'}
        </p>
